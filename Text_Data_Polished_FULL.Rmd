...
```{r}
# library(igraph)
bigram_graph = igraph::graph_from_data_frame(bigram_counts_clean,directed = F)
bigram_graph
...
The hardest part of drawing networks is deciding where to place nodes. The fr layout helps by simulating attraction between connected nodes and repulsion among all nodes. This usually spreads the graph clearly while bringing related nodes together, making clusters and central nodes easier to see. Take a look:
